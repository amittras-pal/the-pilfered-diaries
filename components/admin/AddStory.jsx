          ...
          <div className="d-flex gap-3">
            ...
            >
              <input
                ...
                {...register("draft")}
              />
              <span className="ms-2">Initialize as draft</span>
            </label> */}
          </div>
          {/* {watch("draft") && (
            <ul className="list-unstyled">
              <li className="small text-danger mb-1">
                Story Initialized as draft will have to be manually set to
                published via Firestore.
              </li>
              <li className="small text-danger mb-1">
                The Published date will also not be set
              </li>
            </ul>
          )} */}
        </div>
